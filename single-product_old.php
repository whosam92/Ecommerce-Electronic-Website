...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Subas || Single Product</title>
                        ...
                        <div class="tab-content">
                          ...
                          >
                            ...
                            <p>
                              ...
                              exercitationem. rerum blanditiis dolore
                              dignissimos expedita consequatur deleniti
      ...
      <div class="style-customizer closed">
        <div class="buy-button">
          <a href="index.html" class="customizer-logo"
            ><img src="images/logo/logo.png" alt="Theme Logo"
          /></a>
        ...
        <div class="clearfix content-chooser">
          ...
          <ul class="styleChange clearfix">
            <li
              class="skin-default selected"
              title="skin-default"
              data-style="skin-default"
            ></li>
            <li class="skin-green" title="green" data-style="skin-green"></li>
            <li
              class="skin-purple"
              title="purple"
              data-style="skin-purple"
            ></li>
            ...
            <li
              class="skin-blue-grey"
              title="blue-grey"
              data-style="skin-blue-grey"
            ></li>
          ...
          <ul class="resetAll">
            <li>
              <a class="button button-border button-reset" href="#"
                >Reset All</a
              >
            </li>
          </ul>
