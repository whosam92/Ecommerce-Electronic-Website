  ...
  $.extend($.fn, {
    ...
    applyClasses: function (settings, toggler) {
      ...
      if (!settings.prerendered) {
        ...
        if (!hitarea.length)
          hitarea = this.prepend('<div class="' + CLASSES.hitarea + '"/>').find(
            "div." + CLASSES.hitarea
          );
        hitarea
          .removeClass()
      ...
      switch (settings.persist) {
        ...
        case "location":
          var current = this.find("a").filter(function () {
            return (
              location.href.toLowerCase().indexOf(this.href.toLowerCase()) == 0
            );
          });
          if (current.length) {
...
jQuery(document).ready(function ($) {
    ...
    if (link.length > 0) {
      ...
      if ($(".swicher-title-page-dark").length > 0) {
        ...
        if ($("#logo_dark_img").length > 0) {
          document.getElementById("logo_dark_img").src =
            "images/customizer/logo/dark/logo_" + tp_stylesheet + ".png";
        }
        if ($("#logo-footer").length > 0) {
          document.getElementById("logo-footer").src =
            "images/customizer/logo/logo_" + tp_stylesheet + ".png";
        }
      }
    }
  ...
  if (!$.cookie("customizer_mode")) {
    ...
    $('.style-customizer .layoutstyle li[data-style="wide-layout"]').addClass(
      "selected"
    );
  } else {
  ...
  if (customizer_mode == "boxed-layout" && $.cookie("pattern")) {
    ...
    $('.style-customizer .patternChange li[data-style="pattern-0"]').addClass(
      "selected"
    );
  } else {
  ...
  $(".style-customizer .styleChange li").on("click", function () {
    if (link.length > 0) {
      ...
      if ($(".swicher-title-page-dark").length > 0) {
        document.getElementById("logo_img").src =
          "images/customizer/logo/logo_dark_swicher-title_" +
          tp_stylesheet_no_cookie +
          ".png";
      } else {
        if ($("#logo_img").length > 0) {
          document.getElementById("logo_img").src =
            "images/customizer/logo/logo_" + tp_stylesheet_no_cookie + ".png";
        }
        if ($("#logo_dark_img").length > 0) {
          document.getElementById("logo_dark_img").src =
            "images/customizer/logo/dark/logo_" +
            tp_stylesheet_no_cookie +
            ".png";
        }
        if ($("#logo-footer").length > 0) {
  ...
  $(".style-customizer .patternChange li").on("click", function () {
    ...
    $('.style-customizer .layoutstyle li[data-style="boxed-layout"]').addClass(
      "selected"
    );
    $(
      '.style-customizer .layoutstyle li[data-style="wide-layout"]'
